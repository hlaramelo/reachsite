...
export const metadata: Metadata = {
  ...
  description: "Entre em contato com a Reach Capital. São Paulo, SP.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <ScrollReveal delay={100}>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-navy-900 font-bold mb-1">Endereço</h3>
                      <p className="text-gray-500 text-sm leading-relaxed">
                        {COMPANY.address}<br />CEP {COMPANY.cep}
                      </p>
                    </div>
                  </div>
                </ScrollReveal>
                ...
                <ScrollReveal delay={150}>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-navy-900 font-bold mb-1">Telefone</h3>
                ...
                <ScrollReveal delay={200}>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${COMPANY.email}`} className="text-lime text-sm hover:underline">
                        {COMPANY.email}
                      </a>
                    </div>
                  </div>
                ...
                <ScrollReveal delay={250}>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-navy-900 font-bold mb-2">Redes Sociais</h3>
                      <div className="flex gap-4">
                        <a href={COMPANY.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-500 text-sm hover:text-lime transition-colors">
                          LinkedIn
                        </a>
                        <a href={COMPANY.social.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-500 text-sm hover:text-lime transition-colors">
                          Instagram
                        </a>
                      </div>
                    </div>
              ...
              <ScrollReveal delay={300}>
                <a
                  href={`https://wa.me/${COMPANY.whatsapp}?text=${encodeURIComponent(
                    "Olá! Gostaria de saber mais sobre as estratégias da Reach Capital."
                  )}`}
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    <p className="text-green-800 font-bold text-lg group-hover:text-green-900">
                      Fale pelo WhatsApp
                    </p>
              ...
              <ScrollReveal delay={350}>
                <div className="mt-6 p-6 bg-cream rounded-lg border border-gray-100">
                  <div className="flex items-center gap-3 mb-3">
                    <svg className="w-5 h-5 text-navy-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                    </svg>
                    <p className="text-navy-900 font-bold">Itaim Bibi, São Paulo</p>
                  </div>
                  <a
                    href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(COMPANY.address)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-lime text-sm font-semibold hover:underline"
                  >
